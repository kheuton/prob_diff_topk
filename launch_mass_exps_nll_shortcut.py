...
for K in Ks:
    ...
    base_dir = f"/cluster/tufts/hugheslab/fmuenc01/bird_zero_rand_K{K}_{epochs}_bigFix_nll_shortcut"
                                ...
                                for num_pert_samples in pert_sample_sizes:
                                    for study, context_size in exps_context:
                                        for timescale in tsteps:
                                            ...
                                            data_dir = f'data_dir/{study}/{timescale}_ctxtSize{context_size}_small_5yrTrain' # {code_dir}/
                                            outdir += f'_study{study}_timescale{timescale}_ctxtSize{context_size}_small_5yrTrain'
                                            ...
                                            command = f"code_dir={code_dir} args='{arg_cmd}' sbatch < run_neg_binom_nll_shortcut.slurm"
                                            print(command)
