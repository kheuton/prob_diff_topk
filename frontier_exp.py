...
from models import mixture_poissons,poisson_glm_tract_specific_weights
...
def main(seed=None, num_components=None, learning_rate=None, epochs=None, outdir=None,
         penalty=None, threshold=None, K=None):
    ...
    # NLL loss only
    mix_model_nll, _  = mixture_poissons(poisson_glm_tract_specific_weights, input_shape, num_components=num_components)
    ...
    # BPR loss only
    mix_model_bpr, _  = mixture_poissons(poisson_glm_tract_specific_weights, input_shape, num_components=num_components)
    optimizer = keras.optimizers.Adam(learning_rate=learning_rate)
    ...
    # Penalized loss
    mix_model_penalized, _  = mixture_poissons(poisson_glm_tract_specific_weights, input_shape, num_components=num_components)
    optimizer = keras.optimizers.Adam(learning_rate=learning_rate)
